...
export default class FlightBooking extends Component {
    render() {
        return (
            <div className='FlightPage'>
                <div>
                    {/* <img className='banner' src='/imabanner2.jpg' /> */}
                </div>
                ...
                <div className='flight-type-card-1'>
                        ...
                        <h4 className='flight-type'><em>Travel Light</em></h4>
                        <div className='bag-div'>
                            ...
                            <div>
                                <button className='flight-type-button-1'>Continue with Value Fare</button>
                            </div>
    ...
    {/* +++++++++++   SECOND CARD    ++++++++++++++++                  */}
            ...
            <input className ='input' placeholder='Middle Name (If it appears on your passport' />
            ...
            <div>
                <button className='flight-info-button' >SUBMIT</button>
                    ...
                    <img className='covid-guidelines-img' src='/images/covid-guidelines.jpg' />
