    ...
    return (
        <div>
            ...
            {filteredCountries.map((attractions, index) => {
                ...
                <div className={attractions.status === 'Open'? 'status-open': attractions.status === 'Moderate'? 'status-moderate': 'status-closed'}>
                <h4 className='status-text'>Status: {attractions.status}</h4>
                </div>
                </div>
              
                <AttractionsButton className='card-button' itemIndex={index} text='Show more' action={this.showModal} />
                  ...
                  <div
                    className={
                      attractions.status === "Open"
                        ...
                        ? "status-moderate"
                        : "status-closed"
>>>>>>> 0869f74998d875fe03a9824384fbace8342acbb5
                    }
                  >
